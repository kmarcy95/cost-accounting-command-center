...
(function (root) {
  ...
  var model = {
    ...
    ctx: {
      ...
      landedCost: function () { return { group: d().group, shipments: model.landedShipments() }; },
      subcontracting: function () { return { group: d().group, filter: model.filterLabel(), orders: model.subcontract() }; },
      traceability: function () { return { group: d().group, lots: model.lots() }; },
      costVersions: function () { return { group: d().group, versions: model.costVersions() }; },
